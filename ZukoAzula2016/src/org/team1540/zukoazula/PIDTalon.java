...
public class PIDTalon {
    ...
    public PIDTalon(TalonExtendedMotor tem, String name) {
        this.tem = tem;
        this.name = name;
        ...
        this.targetSpeed = ZukoAzula.mainTuning.getFloat(name + " Target Speed", 30f);
        ...
        tem.modGeneralConfig().configureMaximumOutputVoltage(12.0f, 0.0f);
