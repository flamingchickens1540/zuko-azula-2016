...
public class DriveCode {
    ...
    private static final Behavior teleop = behaviors.addBehavior("Teleop", FRC.inTeleopMode().andNot(KangarooTargeting.enableAutocorrect));
    private static final Behavior targeting = behaviors.addBehavior("Targeting", FRC.inTeleopMode().and(KangarooTargeting.enableAutocorrect));
