...
public class Shooter {
    ...
    public static void setup() throws ExtendedMotorFailureException {
        ...
        BooleanInput prefireButton = (ZukoAzula.controlBinding.addBoolean("Shooter Spinup").or(Autonomous.warmup.and(FRC.inAutonomousMode())));
        BooleanInput fireButton = ZukoAzula.controlBinding.addBoolean("Shooter Fire").or(Autonomous.fire.and(FRC.inAutonomousMode()));
